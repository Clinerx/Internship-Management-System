# Generated by Django 5.0.2 on 2024-11-13 10:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('In Review', 'In Review'), ('Interview Scheduled', 'Interview Scheduled'), ('Offer Extended', 'Offer Extended'), ('Completed', 'Completed')], default='Applied', max_length=50)),
